...
const UpdateUserForm = () => {
    ...
    return (
        ...
        <div className="w-full ">
            <button className="px-5 flex justify-center items-center py-2 w-1/2 hover:bg-indigo-400 transition duration-200 rounded-lg text-xl text-white bg-yellow-500">Update <span><BiBrush size={24}></BiBrush></span></button>
        </div>
       </form>
        </div>
    );
